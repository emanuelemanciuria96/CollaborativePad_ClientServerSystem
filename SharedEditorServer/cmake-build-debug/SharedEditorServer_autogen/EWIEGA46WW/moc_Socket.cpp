...
QT_MOC_LITERAL(3, 20, 10), // "DataPacket"
QT_MOC_LITERAL(4, 31, 3), // "pkt"
QT_MOC_LITERAL(5, 35, 11), // "std::mutex*"
QT_MOC_LITERAL(6, 47, 3) // "mtx"

    },
    "Socket\0sendMessage\0\0DataPacket\0pkt\0"
    "std::mutex*\0mtx"
};
...
void Socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendMessage((*reinterpret_cast< DataPacket(*)>(_a[1])),(*reinterpret_cast< std::mutex*(*)>(_a[2]))); break;
        case 1: _t->sendMessage((*reinterpret_cast< DataPacket(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Socket::*)(DataPacket , std::mutex * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::sendMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Socket::sendMessage(DataPacket _t1, std::mutex * _t2)
{
