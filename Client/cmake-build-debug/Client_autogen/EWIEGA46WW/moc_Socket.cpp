...
QT_MOC_LITERAL(1, 7, 10), // "sendPacket"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 10), // "DataPacket"
QT_MOC_LITERAL(4, 30, 3), // "pkt"
QT_MOC_LITERAL(5, 34, 25) // "terminateThreadOperations"

    },
    "Socket\0sendPacket\0\0DataPacket\0pkt\0"
    "terminateThreadOperations"
};
...
void Socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->terminateThreadOperations(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::terminateThreadOperations)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Socket::terminateThreadOperations()
{
